# FontAwesome 5 for Elm Example. [![Build Status](https://travis-ci.com/Lattyware/elm-fontawesome-example.svg?branch=master)](https://travis-ci.com/Lattyware/elm-fontawesome-example)
