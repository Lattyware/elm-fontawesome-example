...
var $author$project$Example$Change = function (a) {
	return {$: 1, a: a};
};
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$car = A4(
	...
	'car',
	_Utils_Tuple2(512, 512),
	_Utils_Tuple2('M135.2 117.4L109.1 192l293.8 0-26.1-74.6C372.3 104.6 360.2 96 346.6 96L165.4 96c-13.6 0-25.7 8.6-30.2 21.4zM39.6 196.8L74.8 96.3C88.3 57.8 124.6 32 165.4 32l181.2 0c40.8 0 77.1 25.8 90.6 64.3l35.2 100.5c23.2 9.6 39.6 32.5 39.6 59.2l0 144 0 48c0 17.7-14.3 32-32 32l-32 0c-17.7 0-32-14.3-32-32l0-48L96 400l0 48c0 17.7-14.3 32-32 32l-32 0c-17.7 0-32-14.3-32-32l0-48L0 256c0-26.7 16.4-49.6 39.6-59.2zM128 288a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm288 32a32 32 0 1 0 0-64 32 32 0 1 0 0 64z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$chessBishop = A4(
	...
	_Utils_Tuple2('M128 0C110.3 0 96 14.3 96 32c0 16.1 11.9 29.4 27.4 31.7C78.4 106.8 8 190 8 288c0 47.4 30.8 72.3 56 84.7L64 400l192 0 0-27.3c25.2-12.5 56-37.4 56-84.7c0-37.3-10.2-72.4-25.3-104.1l-99.4 99.4c-6.2 6.2-16.4 6.2-22.6 0s-6.2-16.4 0-22.6L270.8 154.6c-23.2-38.1-51.8-69.5-74.2-90.9C212.1 61.4 224 48.1 224 32c0-17.7-14.3-32-32-32L128 0zM48 432L6.6 473.4c-4.2 4.2-6.6 10-6.6 16C0 501.9 10.1 512 22.6 512l274.7 0c12.5 0 22.6-10.1 22.6-22.6c0-6-2.4-11.8-6.6-16L272 432 48 432z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$clock = A4(
	...
	'clock',
	_Utils_Tuple2(512, 512),
	_Utils_Tuple2('M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$circleQuestion = A4(
	...
	'circle-question',
	_Utils_Tuple2(512, 512),
	_Utils_Tuple2('M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM169.8 165.3c7.9-22.3 29.1-37.3 52.8-37.3l58.3 0c34.9 0 63.1 28.3 63.1 63.1c0 22.6-12.1 43.5-31.7 54.8L280 264.4c-.2 13-10.9 23.6-24 23.6c-13.3 0-24-10.7-24-24l0-13.5c0-8.6 4.6-16.5 12.1-20.8l44.3-25.4c4.7-2.7 7.6-7.7 7.6-13.1c0-8.4-6.8-15.1-15.1-15.1l-58.3 0c-3.4 0-6.4 2.1-7.5 5.3l-.4 1.2c-4.4 12.5-18.2 19-30.6 14.6s-19-18.2-14.6-30.6l.4-1.2zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z', $elm$core$Maybe$Nothing));
...
var $author$project$RandomIds$randomId = function () {
	var randomIdChar = A2(
		$elm$random$Random$uniform,
		'0',
		$elm$core$String$toList('123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'));
	return A2(
		$elm$random$Random$map,
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$thumbsUp = A4(
	...
	'thumbs-up',
	_Utils_Tuple2(512, 512),
	_Utils_Tuple2('M313.4 32.9c26 5.2 42.9 30.5 37.7 56.5l-2.3 11.4c-5.3 26.7-15.1 52.1-28.8 75.2l144 0c26.5 0 48 21.5 48 48c0 18.5-10.5 34.6-25.9 42.6C497 275.4 504 288.9 504 304c0 23.4-16.8 42.9-38.9 47.1c4.4 7.3 6.9 15.8 6.9 24.9c0 21.3-13.9 39.4-33.1 45.6c.7 3.3 1.1 6.8 1.1 10.4c0 26.5-21.5 48-48 48l-97.5 0c-19 0-37.5-5.6-53.3-16.1l-38.5-25.7C176 420.4 160 390.4 160 358.3l0-38.3 0-48 0-24.9c0-29.2 13.3-56.7 36-75l7.4-5.9c26.5-21.2 44.6-51 51.2-84.2l2.3-11.4c5.2-26 30.5-42.9 56.5-37.7zM32 192l64 0c17.7 0 32 14.3 32 32l0 224c0 17.7-14.3 32-32 32l-64 0c-17.7 0-32-14.3-32-32L0 224c0-17.7 14.3-32 32-32z', $elm$core$Maybe$Nothing));
...
var $author$project$Example$randomise = A2(
	...
	A2($elm$random$Random$list, 10, $author$project$Example$randomIdAndIcon));
var $author$project$Example$Randomise = {$: 0};
...
var $author$project$Example$subscriptions = function (_v0) {
	return A2(
		$elm$time$Time$every,
		2000,
		$elm$core$Basics$always($author$project$Example$Randomise));
};
...
var $author$project$Example$update = F2(
	function (msg, model) {
		if (!msg.$) {
			return _Utils_Tuple2(model, $author$project$Example$randomise);
		} else {
			var newModel = msg.a;
...
var $author$project$Example$exampleSection = F2(
...
var $lattyware$elm_fontawesome$FontAwesome$styled = F2(
	function (attributes, _v0) {
		...
		return _Utils_update(
			presentation,
			{
				E: _Utils_ap(presentation.E, attributes)
			});
	});
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$book = A4(
	...
	_Utils_Tuple2('M96 0C43 0 0 43 0 96L0 416c0 53 43 96 96 96l288 0 32 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l0-64c17.7 0 32-14.3 32-32l0-320c0-17.7-14.3-32-32-32L384 0 96 0zm0 384l256 0 0 64L96 448c-17.7 0-32-14.3-32-32s14.3-32 32-32zm32-240c0-8.8 7.2-16 16-16l192 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-192 0c-8.8 0-16-7.2-16-16zm16 48l192 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-192 0c-8.8 0-16-7.2-16-16s7.2-16 16-16z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$house = A4(
	...
	_Utils_Tuple2('M575.8 255.5c0 18-15 32.1-32 32.1l-32 0 .7 160.2c0 2.7-.2 5.4-.5 8.1l0 16.2c0 22.1-17.9 40-40 40l-16 0c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1L416 512l-24 0c-22.1 0-40-17.9-40-40l0-24 0-64c0-17.7-14.3-32-32-32l-64 0c-17.7 0-32 14.3-32 32l0 64 0 24c0 22.1-17.9 40-40 40l-24 0-31.9 0c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2l-16 0c-22.1 0-40-17.9-40-40l0-112c0-.9 0-1.9 .1-2.8l0-69.7-32 0c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$info = A4(
	...
	_Utils_Tuple2('M48 80a48 48 0 1 1 96 0A48 48 0 1 1 48 80zM0 224c0-17.7 14.3-32 32-32l64 0c17.7 0 32 14.3 32 32l0 224 32 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 512c-17.7 0-32-14.3-32-32s14.3-32 32-32l32 0 0-192-32 0c-17.7 0-32-14.3-32-32z', $elm$core$Maybe$Nothing));
...
var $author$project$Example$fixedWidthIcons = A2(
	...
	_List_fromArray(
		[
			...
			A2($elm$core$List$map, $author$project$Example$menuItem, $author$project$Example$menuItems))
		]));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$squareCheck = A4(
	...
	'square-check',
	_Utils_Tuple2(448, 512),
	_Utils_Tuple2('M64 32C28.7 32 0 60.7 0 96L0 416c0 35.3 28.7 64 64 64l320 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64L64 32zM337 209L209 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L303 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$calendar = A4(
	...
	'calendar',
	_Utils_Tuple2(448, 512),
	_Utils_Tuple2('M96 32l0 32L48 64C21.5 64 0 85.5 0 112l0 48 448 0 0-48c0-26.5-21.5-48-48-48l-48 0 0-32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 32L160 64l0-32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192L0 192 0 464c0 26.5 21.5 48 48 48l352 0c26.5 0 48-21.5 48-48l0-272z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$Layering$counter = F2(
	function (attrs, count) {
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$elm$html$Html$Attributes$class('fa-layers-counter'),
				attrs),
			_List_fromArray(
				[
...
var $lattyware$elm_fontawesome$FontAwesome$Layering$layers = F2(
	function (attrs, icons) {
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$elm$html$Html$Attributes$class('fa-layers fa-fw'),
				attrs),
			icons);
	});
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$play = A4(
	...
	'play',
	_Utils_Tuple2(384, 512),
	_Utils_Tuple2('M73 39c-14.8-9.1-33.4-9.4-48.5-.9S0 62.6 0 80L0 432c0 17.4 9.4 33.4 24.5 41.9s33.7 8.1 48.5-.9L361 297c14.3-8.7 23-24.2 23-41s-8.7-32.2-23-41L73 39z', $elm$core$Maybe$Nothing));
			...
			$elm$core$List$concat(
				_List_fromArray(
					[
						_List_fromArray(
						[
							$elm$html$Html$Attributes$class('fa-layers-text'),
							A2($elm$html$Html$Attributes$attribute, 'aria-hidden', 'true')
						]),
						transform,
						attrs
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$headphones = A4(
	...
	'headphones',
	_Utils_Tuple2(512, 512),
	_Utils_Tuple2('M256 80C149.9 80 62.4 159.4 49.6 262c9.4-3.8 19.6-6 30.4-6c26.5 0 48 21.5 48 48l0 128c0 26.5-21.5 48-48 48c-44.2 0-80-35.8-80-80l0-16 0-48 0-48C0 146.6 114.6 32 256 32s256 114.6 256 256l0 48 0 48 0 16c0 44.2-35.8 80-80 80c-26.5 0-48-21.5-48-48l0-128c0-26.5 21.5-48 48-48c10.8 0 21 2.1 30.4 6C449.6 159.4 362.1 80 256 80z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$mask = A4(
	...
	'mask',
	_Utils_Tuple2(576, 512),
	_Utils_Tuple2('M288 64C64 64 0 160 0 272S80 448 176 448l8.4 0c24.2 0 46.4-13.7 57.2-35.4l23.2-46.3c4.4-8.8 13.3-14.3 23.2-14.3s18.8 5.5 23.2 14.3l23.2 46.3c10.8 21.7 33 35.4 57.2 35.4l8.4 0c96 0 176-64 176-176s-64-208-288-208zM96 256a64 64 0 1 1 128 0A64 64 0 1 1 96 256zm320-64a64 64 0 1 1 0 128 64 64 0 1 1 0-128z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$withId = F2(
	function (id, _v0) {
		...
		return _Utils_update(
			presentation,
			{
				G: $elm$core$Maybe$Just(id)
			});
	});
var $author$project$Example$masking = A2(
	$author$project$Example$exampleSection,
	'Masking',
	_List_fromArray(
		[
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$circleRight = A4(
	...
	'circle-right',
	_Utils_Tuple2(512, 512),
	_Utils_Tuple2('M0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zm395.3 11.3l-112 112c-4.6 4.6-11.5 5.9-17.4 3.5s-9.9-8.3-9.9-14.8l0-64-96 0c-17.7 0-32-14.3-32-32l0-32c0-17.7 14.3-32 32-32l96 0 0-64c0-6.5 3.9-12.3 9.9-14.8s12.9-1.1 17.4 3.5l112 112c6.2 6.2 6.2 16.4 0 22.6z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$camera = A4(
	...
	'camera',
	_Utils_Tuple2(512, 512),
	_Utils_Tuple2('M149.1 64.8L138.7 96 64 96C28.7 96 0 124.7 0 160L0 416c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-256c0-35.3-28.7-64-64-64l-74.7 0L362.9 64.8C356.4 45.2 338.1 32 317.4 32L194.6 32c-20.7 0-39 13.2-45.5 32.8zM256 192a96 96 0 1 1 0 192 96 96 0 1 1 0-192z', $elm$core$Maybe$Nothing));
...
var $author$project$Example$sizingIcons = A2(
	$author$project$Example$exampleSection,
	'Sizing Icons',
	A2($elm$core$List$map, $author$project$Example$stroopwafel, $author$project$Example$sizes));
var $elm$svg$Svg$Attributes$style = _VirtualDom_attribute('style');
var $author$project$Example$svgIcons = A2(
	$author$project$Example$exampleSection,
	'Icons in an existing SVG element.',
	_List_fromArray(
		[
			A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$style('width: 150px; height: 150px;')
				]),
			_List_fromArray(
				[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://github.com/Lattyware/elm-fontawesome')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('elm-fontawesome')
									]))
							])),
						$author$project$Example$simpleExamples,
						$author$project$Example$sizingIcons,
						$author$project$Example$fixedWidthIcons,
						$author$project$Example$iconsInAList,
						$author$project$Example$animatingIcons,
						$author$project$Example$layeringTextAndCounters,
						$author$project$Example$masking,
						$author$project$Example$randomIds(model),
